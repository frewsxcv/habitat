...
export const CLEAR_INTEGRATIONS = originActions.CLEAR_INTEGRATIONS;
...
export const POPULATE_ORIGIN_INTEGRATIONS = originActions.POPULATE_ORIGIN_INTEGRATIONS;
...
export const deleteIntegration = originActions.deleteIntegration;
...
export const validateIntegrationCredentials = originActions.validateIntegrationCredentials;
export const setIntegration = originActions.setIntegration;
